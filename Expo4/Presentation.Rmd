...
```{r}
model.tso$fit$coef |> length() |> print()

model.arima$coef |> length() |> print()
```
...
- En busca de un modelo que nos pueda ayudar hacer predicción sobre los visitantes que entran a Canadá. Se obtienen dos modelos los cuales se modelan teniendo en cuenta los datos atípicos e intervenciones. Dichos modelos carecen de los supuestos necesarios que nos permitan tener confianza estadística para concluir que se realizan buenas predicciones a futuro.
